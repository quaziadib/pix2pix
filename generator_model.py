...
class Generator(nn.Module):
    ...
    def __init__(self, in_channels=3, features=64):
        ...
        self.up2 = Block(features*16, features*8, down=False,
                         act="relu", use_dropout=True)
        self.up3 = Block(features*16, features*8, down=False,
                         act="relu", use_dropout=True)
        self.up4 = Block(features*16, features*8, down=False,
                         act="relu", use_dropout=False)
        self.up5 = Block(features*16, features*4, down=False,
                         act="relu", use_dropout=False)
        self.up6 = Block(features*8, features*2, down=False,
                         act="relu", use_dropout=False)
        self.up7 = Block(features*4, features, down=False,
                         act="relu", use_dropout=False)
